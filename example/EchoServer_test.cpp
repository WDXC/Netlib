...
public:
    ...
    {
        //注册回调函数
        server_.setConnectionCallback(bind(&EchoServer::on_connection, this, _1));
        server_.setMessageCallback(bind(&EchoServer::on_message, this, _1, _2, _3));
...
private:
    ...
    {
        string msg = buffer->retrieve_asString();
        conn->send(msg);
        conn->shutdown();
    }
